...
import loginBackground from '../assets/bglogin.png';
import axiosInstance from "../axiosInstance.jsx"; // Import axiosInstance for making API requests
import { buttonHoverAnimaiton } from '../utils/TailwindUtlis.jsx'; // Import animation utility
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Redirect to interface page upon successful login
